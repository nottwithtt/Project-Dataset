...
async function getLikedDatasets(){
    ...
    for(let i = 0;i<datasets.length;i++){
        ...
        const likes = await fetch('/getLikesDataset',{
          ...
          divPrincipal.innerHTML = `<a href="ViewDataset?dataset=${datasets[i].id_mongo}&name=${datasets[i].name}" class="container d-flex flex-column list-group-item list-group-item-action ">
